...
if($res->num_rows > 0){
	...
	<body>
		...
		<div class='titulo-pagina'>
			<h1>Alterar dados do produto(roupa)</h1>
		</div>

		<section class='card-cadastro-roupa'>
			<div class='container' style='min-height: 960px;'>
				<form method='POST' action='alterar-roupas-definitivo.php' enctype='multipart/form-data' autocomplete='off'>
					...
					<div class='inputs-card-roupas6'>
						...
						<input type='number' name='tamP' value='".$registro['QtdP']."'><br>
						<label for='tamM'>M</label>
						<input type='number' name='tamM' value='".$registro['QtdM']."'><br>
						<label for='tamG'>G</label>
						<input type='number' name='tamG' value='".$registro['QtdG']."'><br>
						<label for='tamGG'>GG</label>
						<input type='number' name='tamGG' value='".$registro['QtdGG']."'><br>
					</div>	
