...
if($res->num_rows > 0){
	...
	<body>
		...
		<div class='titulo-pagina'>
			<h1>Excluir produto(calçado)</h1>
		</div>

		<section class='card-cadastro-calcado'>
			<div class='container' style='min-height: 870px;'>
				<form method='POST' action='excluir-calcado-definitivo.php' enctype='multipart/form-data' autocomplete='off'>
					...
					<div class='inputs-card-roupas6'>
						...
						<input type='number' name='tam35' value='".$registro['Qtd35']."' disabled>
						<label for='tam36'>36</label>
						<input type='number' name='tam36' value='".$registro['Qtd36']."' disabled>
						<label for='tam37'>37</label>
						<input type='number' name='tam37' value='".$registro['Qtd37']."' disabled>
						<label for='tam38'>38</label>
						<input type='number' name='tam38' value='".$registro['Qtd38']."' disabled>
						<label for='tam39'>39</label>
						<input type='number' name='tam39' value='".$registro['Qtd39']."' disabled><br>
						<label for='tam40'>40</label>
						<input type='number' name='tam40' value='".$registro['Qtd40']."' disabled>
						<label for='tam41'>41</label>
						<input type='number' name='tam41' value='".$registro['Qtd41']."' disabled>
						<label for='tam42'>42</label>
						<input type='number' name='tam42' value='".$registro['Qtd42']."' disabled>
						<label for='tam43'>43</label>
						<input type='number' name='tam43' value='".$registro['Qtd43']."' disabled>
						<label for='tam44'>44</label>
						<input type='number' name='tam44' value='".$registro['Qtd44']."' disabled>
					</div>		
					...
					<div class='btn-excluir'>
						<input type='submit' name='salvar' value='Excluir'>						
					</div>
				</form>
			</div>
